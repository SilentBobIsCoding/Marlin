...
// My Prusa 
    #define  DEFAULT_Kp 17.92 //22.2
    #define  DEFAULT_Ki 1.26  //1.08  
    #define  DEFAULT_Kd 63.49 //114
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {(200*16)/(2.0*20), (200*16)/(2.0*20), (200*16)/1, 750}  // changed: steps per unit Prusa i2 723 - (780)
